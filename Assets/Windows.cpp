...
int WINAPI wWinMain( HINSTANCE hInst,HINSTANCE,LPWSTR,INT )
{
    ...
    HWND hWnd = CreateWindowW( L"Pokémon Battle Arena",L"Pokémon Battle Arena",
    ...
    UnregisterClass( L"Pokémon Battle Arena Window",wc.hInstance );
    return 0;
}